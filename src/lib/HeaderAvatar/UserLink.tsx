...
>
    {icon && <div className="w-6 [&:has(>img)]w-10 min-w-[24px] [&:has(>img)]:min-w-[40px] flex justify-center items-center aspect-square rounded-full overflow-hidden shadow-[0_0_0_3px_#282828]">{icon}</div>}
